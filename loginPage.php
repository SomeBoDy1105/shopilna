                ...
                <div class="card " style="background: rgba(255,255,255,0);border-style: none;">
                    <div class="card-body d-flex flex-column align-items-center mb-0"
                        ...
                        <form class="text-center" action="config/login.php" method="post">
                            <div class=" mb-3 ">
                                <label>
                                    <input class="form-control" type="email" name="email"
                                           placeholder="Email" autofocus="autofocus" autocomplete="on"
                                           inputmode="email" required
                                           pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" action=' '>
                                </label>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3" style="border-width: 0;"><input class="btn btn-primary d-block w-100"
                                                                              type="submit" name="login" value="Login"
                                                                              style="background: #8aa5ad;border-radius: 8px;border-width: 0;border-style: none;">
                            </div>
                            <a href="password.php">
                                <p style="color:#463d3a ; font-weight: bold;border: 0 none var(--bs-blue);">
                                    Forgot your password?</p>
                            </a>
                            <p style="color: rgb(70, 61, 58);"> Not a member? <a
                                        style="color: #463d3a;font-weight: bold;border: 0 none var(--bs-blue);"
                                        href="users/register.php">Register</a>&nbsp; </p>
                        </form>
                    </div>
                </div>
            </div>
