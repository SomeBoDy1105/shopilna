...
<nav class="navbar navbar-light navbar-expand-md sticky-top" style="background: var(--bg-primary);">
    <div class="container-fluid"><a class="navbar-brand" href="index.php"
            style="padding-left: 0px;margin-left: 26px;margin-right: 56px;"><strong>Shopilna</strong></a><button
            data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span
                class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse flex-row justify-content-end" id="navcol-1">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false"
                        data-bs-toggle="dropdown" style="color:var(--bg-secondary);" href="#">Women</a>
                    <div class="dropdown-menu">
                        <?php foreach ($myCategories as $category) : ?>
                        <a class="dropdown-item" href="#"><?= $category->nom ?></a>
                        <div class="dropdown-divider"></div>
                ...
                class="btn d-xl-flex justify-content-center align-items-center align-content-center ms-auto justify-content-xl-start align-items-xl-center"
                type="button" style="background: #181720;margin-right: 4px; color:white">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16"
                    ...
                    class="d-xl-flex justify-content-center align-items-center justify-content-xl-center align-items-xl-center">Cart</span></button>
            <a class="btn active d-xl-flex align-content-center  justify-content-xl-center align-items-xl-center"
                ...
                href="ProfilePage.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                    ...
                    style="margin-top: 0px;padding-top: 0px;">Account</span></a>
